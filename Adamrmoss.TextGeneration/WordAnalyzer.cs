...
namespace Adamrmoss.TextGeneration
{
    public class WordAnalyzer
    {
        ...
        public ISet<string> AnalyzedWords { get; }

        public Dictionary<int, int> WordLengthFrequency { get; }
        public Dictionary<string, int> InitialSubwordFrequency { get; }
        public Dictionary<string, Dictionary<string, int>> SubwordFollowingFrequency { get; }
        public HashSet<string> FinalSubwords { get; }
